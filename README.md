...
Who is AutoGrid for?
--------------------
**AutoGrid** is designed for developers who either do not want or do not have the time to write grids for Doctrine entities. 
...
Technical notice
----------------
AutoGrid is built for **Symfony 7+** and **PHP 8.3+**. It uses the **Bootstrap 5** theme and icons to display content nicely.
...
Initially, it's recommended to include the Bootstrap theme (even from a CDN) to see how it is supposed to look by default. 
This will help you customize AutoGrid templates for your specific theme.
